    ...
    public partial class IdDocument
    {
        ...
        private async Task HandleFileUpload(InputFileChangeEventArgs e)
        {
            try
            {
                ...
                {
                    uploadMessage = "Please select a JPG, JPEG, or PNG file.";
                ...
                var apiInvokeUrl = $"{apiBaseUrl}{apiPath}?docuType=2"; //1 = INCOMESTATEMENT, 2 = ID, 3 = SELFIE
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    Parent.GoToStep(ApplicationSteps.Selfie);
                }
                else
                {
